<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = "insert into transaksi (id,peminjam,ruangan,jam_masuk,jumlah_jam,matakuliah,kode_dosen,tanggal,kebutuhan,bukti,status,keterangan) values (NULL,?,?,?,?,?,?,?,NULL,NULL,'pending','kelas')";
    $q = $sql->prepare($query);
    $q->bind_param("sssssss", $idx, $ruang, $jam_masuk, $jumlah_jam, $matakuliah, $kode_dosen, $tanggal);
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Peminjaman Ruang Kelas | Peminjaman Ruangan FIT</title>
